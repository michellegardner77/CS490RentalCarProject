...
public class TabWindowFrameHandler {
    ...
    void initialize() {
        ...
        assert customerRentedCarsSearchButton != null : "fx:id=\"customerRentedCarsSearchButton\" was not injected: check your FXML file 'landing.fxml'.";
        ...
        assert customerInformationTable != null : "fx:id=\"customerInformationTable\" was not injected: check your FXML file 'landing.fxml'.";
